const PASTE_VALIDATOR_ENABLED_MODULES = new Set<string>(['m1', 'm2', 'm3', 'm4', 'm5', 'm6', 'm7', 'm8']);
 ...
 * `hermes-mastery-validator/docs/step5-probe-and-findings.md` and confirming both assumptions hold.
 *
