...
export const StepDo = ({
  ...
  return (
    <div className="space-y-3">
      ...
      {requiresInput && (
        <div className="bg-hermes-bg3 p-4 rounded-xl border border-hermes-border mb-4">
          <label className="block text-[11px] font-bold text-hermes-dark/50 uppercase tracking-wider mb-2 px-1">
            {requiresInput.label}
          </label>
          <input
            type="text"
        ...
        <div className="flex items-center justify-between gap-3 px-6 py-4 bg-hermes-bg3 border-t border-hermes-border">
          <div className="flex flex-wrap items-center gap-4 w-full">
            <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 bg-hermes-accent text-white rounded-xl text-sm font-bold hover:scale-[1.02] active:scale-[0.98] disabled:opacity-30 disabled:grayscale disabled:scale-100 transition-all shadow-md shadow-hermes-accent/20"
            >
              {copied ? (
                <>
